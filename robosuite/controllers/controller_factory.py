...
from .osc_FF import OperationalSpaceControllerFeedForward
...
def controller_factory(name, params):
    ...
    if name == "OSC_POSE_FEEDFORWARD":
        ...
        if interpolator is not None:
            ...
            ori_interpolator.set_states(ori="euler")
        params["control_ori"] = True
        return OperationalSpaceControllerFeedForward(interpolator_pos=interpolator, interpolator_ori=ori_interpolator, **params)
